...
/// badges here.
fn type_badges(feature_types: &[FeatureType]) -> impl IntoView {
    ...
    labels
        ...
        .map(|label| {
            view! {
                <span class="badge badge-outline badge-sm font-normal mr-1">{label}</span>
            }
        })
        .collect_view()
}
...
#[component]
fn OptionalFeatureDetailCard(feature: OptionalFeature) -> impl IntoView {
